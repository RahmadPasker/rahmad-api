...
var creatorList = ['@zahirrr','@zhirrrgans','@zhirr_ajalah','@zahiranjay', '@MadPaskersss','@zhirrganteng','@zahirrgantengg'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'MadPasker') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'MadPasker') return res.json(loghandler.invalidKey)
